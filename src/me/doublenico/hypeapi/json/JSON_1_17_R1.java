...
public class JSON_1_17_R1 implements JSON_Handler {
    ...
    public void sendJSON(Player player, String json) {
        try {
            ...
            PacketPlayOutChat packet = new PacketPlayOutChat(jsonMessage, ChatMessageType.b, player.getUniqueId());
    ...
    public void sendListJSON(Player player, List<String> jsonList) {
        ...
        try {
        	...
        	PacketPlayOutChat packet = new PacketPlayOutChat(json, ChatMessageType.b, player.getUniqueId());
        	((CraftPlayer)player).getHandle().b.sendPacket(packet);
        }
        catch (Exception e) {
