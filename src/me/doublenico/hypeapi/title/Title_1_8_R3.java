...
public class Title_1_8_R3 {

	
	private PacketPlayOutTitle title;
	private PacketPlayOutTitle subtitle;
	
	public Title_1_8_R3(String title, String subtitle, int fadeIn, int stay, int fadeOut) {
	...
	public Title_1_8_R3(String title, String subtitle) {
	...
	public Title_1_8_R3(String title) {
		this.title = new PacketPlayOutTitle(EnumTitleAction.TITLE, ChatSerializer.a("{\"text\":\"" + title + "\"}"), 20, 40, 20);;
	}
